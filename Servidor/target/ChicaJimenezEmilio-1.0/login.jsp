		...
		<div class="col-md-8 col-md-offset-2">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<form class="form-horizontal" role="form" method="POST" action="ServletLogin">
						...
						<div class="form-group">
							<div class="col-md-6 col-md-offset-4">
								...
								<a href="registro.jsp" class="btn btn-primary">Registrarse</button>
								<a class="btn btn-link" href="recordar.jsp">Olvidaste tu contraseña?</a>
							</div>
						</div>
					</form>
				</div>
