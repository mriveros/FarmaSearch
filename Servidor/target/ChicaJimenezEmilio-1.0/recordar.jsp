...
<div class="container">
  ...
  <div class="panel panel-default">
                  <div class="panel-heading">Recordar</div>
                   
      <div class="panel-body">
                            <form method="POST" action="enviarEmail.jsp" accept-charset="UTF-8" autocomplete="on" class="form-horizontal" role="form">
                 ...
                 <div class="text-right">
                                ...
                                <input class="btn btn-default btn-sm" type="submit" value="Recordar">
